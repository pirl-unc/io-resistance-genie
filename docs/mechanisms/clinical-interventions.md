...
- <span class="sp sp-human">human</span> **COMPASS, a pan-cancer concept bottleneck transformer using 44 interpretable immune-concept features from bulk tumor RNA-seq, predicts ICI response and generalizes across cancer types and treatment regimens**[^doi:10.1038/s41591-026-04502-7]. Each immune concept encodes a biologically grounded TME feature — immune cell states, macrophage polarization, T cell exhaustion programs — providing mechanistic interpretability absent from black-box classifiers. Validated across multiple independent cohorts; may complement or supersede PD-L1/TMB/dMMR staging in ICI candidate selection.
- <span class="sp sp-human">human</span> **Mutant KRAS peptide vaccine (mKRAS-VAX) targeting six KRAS mutations (G12D/V/R/C/A, G13D) combined with nivolumab + ipilimumab meets safety and immunogenicity primary endpoints in 13 patients with pretreated metastatic MMRp/MSS CRC** (phase I)[^doi:10.1038/s41467-026-74711-8]. KRAS-specific T cell responses induced in 8/12 evaluable patients. Addresses the core ICI-resistance mechanism of MSS CRC — low tumor neoantigen burden — by supplying shared KRAS neoantigens; clinical activity signals in an indication where PD-1 monotherapy has uniformly failed.
- <span class="sp sp-mouse">mouse</span> **PROTEXI, a DC-based vaccine incorporating SARS-CoV-2 Spike helper epitopes, repurposes pre-existing antiviral CD4+ T cell memory to amplify tumor-specific CD8+ cytotoxic responses in melanoma and breast cancer mouse models; efficacy is enhanced by checkpoint immunotherapy combination**[^doi:10.1038/s41467-026-74891-3]. Pandemic-primed SARS-CoV-2-specific CD4 memory — present in virtually the entire global adult population — functions as a universal pre-formed helper signal that bypasses the CD4 help deficiency limiting conventional cancer vaccines. Rationale: inadequate CD4 help is a recognized bottleneck for vaccine-induced CD8 priming; the COVID-19 pandemic unintentionally primed this helper capacity at population scale. Mouse preclinical; awaits human validation.
- <span class="sp sp-human">human</span> **VERSATILE-002 phase 2: HPV16-targeted T cell vaccine (PDS0101/Versamune HPV) + pembrolizumab achieves 39.3-month median OS in ICI-naive HPV16+ R/M HNSCC** (Weiss et al. 2026, JAMA Oncology)[^doi:10.1001/jamaoncol.2026.3492]. Among 53 ICI-naive patients with CPS ≥1 (mITT), ORR 36% and mOS 39.3 months (95% CI 23.9–NE) — nearly 3× historical pembrolizumab monotherapy benchmarks. In the low PD-L1 subgroup (CPS 1-19), mOS reached 29.5 months (95% CI 15.3–NE), where single-agent checkpoint therapy typically offers limited benefit. PDS0101 delivers HPV16 E6/E7 peptides via Versamune lipid nanoparticles to prime antigen-specific CD8+ T cells; pembrolizumab then sustains their activity via PD-1 blockade. First phase 2 clinical evidence that tumor-antigen vaccine-driven T cell priming overcomes primary ICI resistance mechanism of insufficient tumor-reactive T cell pool — extends mKRAS-VAX (phase I MSS CRC) proof-of-concept into a larger trial in HPV16+ HNSCC.
...
| [Weiss 2026](https://doi.org/10.1001/jamaoncol.2026.3492) | n=53 (mITT population with CPS ≥1; ICI-naive) | HPV16-targeted T cell vaccine (PDS0101) + pembrolizumab in HPV16+ R/M HNSCC | OS mOS 39.3 mo (CPS ≥1); 29.5 mo (CPS 1-19); ORR 36% | CPS ≥1: 95% CI 23.9–NE; CPS 1-19: 95% CI 15.3–NE | Phase 2 nonrandomized clinical trial |
<!-- STUDY-TABLE:END -->
...
[^doi:10.1001/jamaoncol.2026.3492]: Weiss J et al. 2026 JAMA Oncology — VERSATILE-002 phase 2 nonrandomized trial; PDS0101 (HPV16 E6/E7 Versamune vaccine) + pembrolizumab in HPV16+ R/M HNSCC; mOS 39.3 mo (CPS ≥1, n=53), 29.5 mo (CPS 1-19); ORR 36%; first clinical evidence that HPV16-targeted neoantigen vaccination overcomes primary PD-1 resistance in low PD-L1 HNSCC. [Link](https://doi.org/10.1001/jamaoncol.2026.3492).
