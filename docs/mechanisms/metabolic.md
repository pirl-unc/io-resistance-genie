...
- <span class="sp sp-mouse">mouse</span> **Iron-mediated ferroptosis limits T cell persistence in solid tumors via the ACSL4 axis: elevated TME iron promotes ACSL4-dependent ferroptotic cell death in CAR-T cells; ACSL4 ablation substantially improves persistence and antitumor efficacy across multiple solid tumor models** (Nature Cancer 2026)[^doi:10.1038/s43018-026-01187-2]. Complements the immune-STING→cPLA2→ACSL4 lactylation axis (paracrine tumor ferroptosis) already in this synthesis — extending ACSL4 ferroptosis biology to T cell-intrinsic vulnerability driven by TME iron accumulation rather than post-translational ACSL4 modification. While demonstrated in CAR-T, the iron-ACSL4 axis is mechanistically relevant to endogenous T cell fate under ICB.
- <span class="sp sp-mouse">mouse</span> **NDUFA9, a mitochondrial complex I subunit, governs NK cell metabolic fitness in the GBM TME; NDUFA9-deficient NK cells show impaired OXPHOS and reduced cytotoxicity, and restoring NDUFA9 or engineering NK cells with enhanced complex I activity improves antitumor efficacy in glioblastoma** (Cancer Discovery 2026)[^doi:10.1158/2159-8290.CD-25-0643]. Extends the metabolic resistance narrative — previously focused on T cell bioenergetics (MEK overload, citraconate, BETi/ODC1 polyamine axis) — to NK cell complex I biology, identifying a distinct immune-cell-type-specific metabolic vulnerability in a tumor type stubbornly non-responsive to ICB.
...
[^doi:10.1038/s43018-026-01187-2]: Nature Cancer 2026 (PMID 42270901) — Elevated TME iron promotes ACSL4-dependent ferroptosis in CAR-T cells in solid tumors; ACSL4 ablation improves T cell persistence and antitumor efficacy. [Link](https://doi.org/10.1038/s43018-026-01187-2).
[^doi:10.1158/2159-8290.CD-25-0643]: Cancer Discovery 2026 (PMID 41944586) — NDUFA9/mitochondrial complex I governs NK cell OXPHOS fitness in GBM; NDUFA9-deficient NK cells show impaired cytotoxicity; restoring NDUFA9 or engineering NK cells with enhanced complex I activity improves antitumor efficacy. [Link](https://doi.org/10.1158/2159-8290.CD-25-0643).
