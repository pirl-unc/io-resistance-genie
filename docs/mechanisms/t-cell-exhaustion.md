...
- <span class="sp sp-human">human</span> <span class="sp sp-invitro">in vitro</span> **BET bromodomain inhibitors (BETis) reinvigorate exhausted CD8+ T cells from lung cancer malignant pleural effusions via the MYC-ODC1 polyamine biosynthesis axis**[^doi:10.1038/s41590-026-02515-5]. BETis activate MYC→ODC1, expand intracellular polyamine pools, and alter chromatin accessibility; scRNA-seq demonstrates a shift from terminal toward progenitor-like exhausted T cells. ODC1 inhibition (genetic and pharmacological) abolishes the reinvigoration effect. The proximate mechanism is metabolic — polyamine pool expansion — rather than direct epigenetic reversal of TOX or NFAT, suggesting a new entry point for combining epigenetic inhibitors with canonical checkpoint blockade.
...
[^doi:10.1038/s41590-026-02515-5]: NTU 2026 Nature Immunology — BETi epigenetic reprogramming of T cell metabolism via MYC-ODC1 polyamine axis; reinvigorates exhausted T cells from lung cancer MPEs; ODC1 inhibition ablates effect. [Link](https://doi.org/10.1038/s41590-026-02515-5).
