...
- <span class="sp sp-mouse">mouse</span> <span class="sp sp-invitro">in vitro</span> **Common TP53 mutations (G242V, S258I) in CRC selectively retain mTORC1-suppressive function, driving autophagy-mediated resistance to IFN-γ/TNF-α apoptosis and anti-PD-1 therapy**[^doi:10.1038/s41419-026-09067-4]. CRISPR deletion of mutant Trp53 in MC38 CRC cells restores mTORC1, reduces autophagy, markedly increases CD8+ TIL infiltration and clonal expansion, and reduces Tregs; pharmacological mTOR activation or autophagy inhibition phenocopies sensitization to ICI. Human CRC cell lines confirm regulation of the same mTORC1 inhibitor gene sets. Two specific mutations characterized (G242V, S258I); generalizability to all p53 mutants and to MSS CRC (MC38 is MSI-H) not yet established. Identifies a druggable vulnerability — mTOR activation or autophagy inhibition — for combining with ICI in the most common mutation in MSS CRC.
...
- <span class="sp sp-mouse">mouse</span> <span class="sp sp-human">human</span> **TRAILshort, a dominant-negative TRAIL splice variant expressed by cancer cells, disrupts TCR signaling via SHP-1-mediated ZAP-70 dephosphorylation, impairing T cell tumor recognition and blocking CAR-T cell activity**[^doi:10.1172/jci194449]. TRAILshort binds DR5 on T cells, recruits SHP-1 phosphatase, and dephosphorylates ZAP-70 (characterized by phosphoproteomics); in humanized mouse models, TRAILshort promotes tumor persistence and antagonizes CAR-T therapy; blocking TRAILshort restores T cell activity. TRAILshort RNA is elevated in human neoplasms. Identifies a previously unknown dual function of TRAILshort — beyond inhibiting TRAIL-induced apoptosis — as a tumor-secreted direct TCR signaling inhibitor, mechanistically orthogonal to all known checkpoint and resistance mechanisms (Jalali et al. 2026, JCI).
...
[^doi:10.1172/jci194449]: Jalali et al. 2026 JCI — TRAILshort TRAIL splice variant; DR5-SHP-1-ZAP-70 TCR disruption mechanism; humanized mouse models; TRAILshort elevated in human cancers; blocks CAR-T; anti-TRAILshort restores T cell immunity. [Link](https://doi.org/10.1172/jci194449).
